      ...
      <div className={`${classes.footer__down} container`}>
        <div className="row">
          ...
          <div className={`col-12 col-md-9 p-1 text-center text-lg-left`}>
            <span> SẢN PHẨM CỦA CÔNG TY CỔ PHẦN HIẾU TRANG</span>
            <span>Địa chỉ: Hai Bà Trưng, Hà Nội, Việt Nam.</span>
            <span>Giấy chứng nhận đăng ký kinh doanh số: 0101659783,</span>
            <span>đăng ký thay đổi lần thứ 30, ngày 22 tháng 02 năm 2024 do Sở kế hoạch và đầu tư Thành phố Hà Nội cấp.</span>
            <span>Số Điện Thoại (Hotline): 1900 545 436</span>
            <p>Email: <span className="d-inline">trang@gmail.com</span></p>
          </div>
